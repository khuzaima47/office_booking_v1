defmodule OfficeBookingWeb.RoomLiveTest do
  use OfficeBookingWeb.ConnCase

  import Phoenix.LiveViewTest
  import OfficeBooking.RoomsFixtures

  @create_attrs %{name: "some name", description: "some description", location: "some location", capacity: 42, is_active: true}
  ...
  @invalid_attrs %{name: nil, description: nil, location: nil, capacity: nil, is_active: false}
