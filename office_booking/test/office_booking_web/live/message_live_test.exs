defmodule OfficeBookingWeb.MessageLiveTest do
  use OfficeBookingWeb.ConnCase

  import Phoenix.LiveViewTest
  import OfficeBooking.MessagingFixtures

  @create_attrs %{subject: "some subject", content: "some content", read_at: "2025-08-31T06:44:00Z"}
  @update_attrs %{subject: "some updated subject", content: "some updated content", read_at: "2025-09-01T06:44:00Z"}
