defmodule OfficeBookingWeb.BookingLiveTest do
  use OfficeBookingWeb.ConnCase

  import Phoenix.LiveViewTest
  import OfficeBooking.BookingsFixtures

  @create_attrs %{status: "some status", description: "some description", title: "some title", start_datetime: "2025-08-27T09:03:00Z", end_datetime: "2025-08-27T09:03:00Z"}
  @update_attrs %{status: "some updated status", description: "some updated description", title: "some updated title", start_datetime: "2025-08-28T09:03:00Z", end_datetime: "2025-08-28T09:03:00Z"}
